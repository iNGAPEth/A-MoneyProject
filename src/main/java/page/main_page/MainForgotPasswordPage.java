...
public class MainForgotPasswordPage extends BasePage {
    ...
    private static final String FILL_SIX_CODE_FIELD_FORGOT_PASSWORD_FRAME_XPATH_LOCATOR =
            "//*[@id='root']/div[2]/div[5]/div/div[2]/div[2]/form/div[1]/div[1]/div";
    private static final String PUT_CURSOR_INTO_CREATE_PASSWORD_FIELD_RECOVERY_FRAME_XPATH_LOCATOR = "//*[@id=':ra:']";
    private static final String FILL_CREATE_PASSWORD_FIELD_RECOVERY_FRAME_XPATH_LOCATOR = "//*[@id=':ra:']";
    ...
    public MainForgotPasswordPage fillSixSymbolsCodeFieldForgotPasswordFrame(String usercode) {
        ExpectedCondition<WebElement> condition =
                ExpectedConditions.visibilityOf
                        (driver.findElement
    ...
    public MainForgotPasswordPage fillCreatePasswordFieldRecoveryFrame(String usernumber) {
        ExpectedCondition<WebElement> condition =
                ExpectedConditions.visibilityOf
